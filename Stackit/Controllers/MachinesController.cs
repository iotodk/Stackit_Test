...
namespace Stackit.Controllers
{
    public class MachinesController : Controller
    {
        ...
        public MachinesController(StackitDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MachineId,Name,Description")] Machine machine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MachineId,Name,Description")] Machine machine)
        {
